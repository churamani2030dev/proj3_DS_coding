...
class ReportDropdown(Dropdown):
    ...
    def build_component(self, r=None, model: QueryBase = None):
        #  Set the `label` attribute so it is set
        #  to the `name` attribute for the model
        self.label = getattr(model, "name", "Select")
        # Return the output from the
        # parent class's build_component method
        return super().build_component(r, model)
    
    # Overwrite the `component_data` method
    # Ensure the method uses the same parameters
    # as the parent class method
    def component_data(self, r=None, model: QueryBase = None):
...
class Header(BaseComponent):
    ...
    # as the parent class
    def build_component(self, r=None, model: QueryBase = None, entity_id=None):
        # Using the model argument for this method
        # return a fasthtml H1 objects
        # containing the model's name attribute
        return H1(getattr(model, "name", "Report"))
...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, r=None, model: QueryBase = None, asset_id=None):
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, r=None, model: QueryBase = None, asset_id=None):
        ...
        if getattr(model, "name", "").lower() == "team":
            ...
            pred = float(p1[0]) if len(p1) else 0.0
...
class NotesTable(DataTable):
    ...
    def component_data(self, r=None, model: QueryBase = None, entity_id=None):
